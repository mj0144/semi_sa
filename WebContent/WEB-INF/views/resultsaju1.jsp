		 			...
		 			<h3><strong><a href="listSome?code=1">다른 테스트</a></strong></h3> 
				 	 ...
				 	 <div class="single-team">
			    			...
			    			<div class="col-md-12">
								...
								<img src="resources/img/sajutest2.jpg" alt="iljuanimal" style="margin-top: 10px;" class="col-md-12">
								</div>
								<div class="blog-entry ftco-animate d-md-flex">
								<img src="resources/img/sajutest3.jpg" alt="iljuanimal" style="margin-top: 10px;" class="col-md-12">
								</div>
								<div>
				              		<p class="mb-2"></p>
				           	 			<div class="meta-wrap">
