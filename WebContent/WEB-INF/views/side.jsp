				...
				<div id="dropdown-lvl1" class="panel-collapse collapse">
					<div class="panel-body">
						<ul class="nav navbar-nav">
							<li style="font-size: 12px; margin-top: 5px; margin-bottom: 1px;"><a href="listSome?code=1">이성</a></li>
							<li style="font-size: 12px; margin-bottom: 0px;"><a href="listFriend?code=1">동성</a></li>
						</ul>
					</div>
				</div>
			</li>
