		...
		<div class="container">
			...
			<div class="row no-gutters">
				<div class="col-sm-12 col-md ftco-animate">
					<a href="friend"> <img src="images/image_1.jpg"
						class="photography-entry img d-flex justify-content-start align-items-end"
						style="width: 200px; height: 200px;">
				</div>
				<div class="col-sm-12 col-md ftco-animate">
					<a href="friend"> <img src="images/image_2.jpg"
						class="photography-entry img d-flex justify-content-start align-items-end"
						style="width: 200px; height: 200px;">
						<div class="overlay"></div></a>
				</div>
				<div class="col-sm-12 col-md ftco-animate">
					<a href="friend"> <img src="images/image_3.jpg"
						class="photography-entry img d-flex justify-content-start align-items-end"
						style="width: 200px; height: 200px;">
						<div class="overlay"></div></a>
				</div>
				<div class="col-sm-12 col-md ftco-animate">
					<a href="friend"> <img src="images/image_4.jpg"
						class="photography-entry img d-flex justify-content-start align-items-end"
						style="width: 200px; height: 200px;">
						<div class="overlay"></div></a>
				</div>
				<div class="col-sm-12 col-md ftco-animate">
					<a href="friend"> <img src="images/image_5.jpg"
						class="photography-entry img d-flex justify-content-start align-items-end"
						style="width: 200px; height: 200px;">
						<div class="overlay"></div></a>
				</div>
