				...
				<div class="author-info text p-4 p-md-5 mt-5 mb-5">
					<div class="desc">
						<div style="margin-top: -100px; margin-bottom: 40px;">
							...
							</p><!-- style="background-image: url(images/joehyun.jpg); -->
				...
				<div class="col-md-10">
					<div class="row">
						...
						<div
							...
							<div class="block-18">
								<div class="text d-flex align-items-center">
									<strong class="number" data-number="${follower}">0</strong> <span>팔로워</span>
								</div>
							</div>
						</div>
						<div
							...
							<div class="block-18">
								<div class="text d-flex align-items-center">
									<strong class="number" data-number="${follow}">0</strong> <span>팔로우</span>
								</div>
							</div>
						</div>
						<div
							...
							<div class="block-18">
								<div class="text d-flex align-items-center">
									<strong class="number" data-number="${board.maxnum}">0</strong> <span>게시물</span>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="photograhy">
			...
			<c:forEach var="e" items="${list }">
				<div class="col-md-4 ftco-animate">
					<a href="board">
						<img src="images/${e.board_img }" class="photography-entry img d-flex justify-content-start align-items-end" style="width: 420px;">
						<div class="overlay"></div>
					</a>
				</div>
			</c:forEach>
