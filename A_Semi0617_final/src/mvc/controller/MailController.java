...
public class MailController {
	...
	public ModelAndView passEmail(HttpServletRequest request, MemberVO vo, HttpServletResponse response) throws Exception{
    ...
    public ModelAndView pass_injeung(String pass_injeung, @RequestParam(value = "dice", required=false) String dice, @RequestParam(value = "email",required=false) String email, 
  ...
  //변경할 비밀번호를 입력한 후에 확인 버튼을 누르면 넘어오는 컨트롤러
    ...
    public ModelAndView pass_change(@RequestParam(value ="email", required = false) String email, HttpServletRequest request, MemberVO vo, HttpServletResponse response) throws Exception{        
