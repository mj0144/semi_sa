...
<body>
				...
				<form class="form-horizontal" method="post"
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input placeholder="이름" type="text" required="required"
									name="name" id="name" onchange="namechange()" value="${vo.NAME }"><label
									id="namelabel"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input placeholder="별명" type="text" name="nickname"
									id="nickname" value="${vo.NICKNAME }" onchange="nickchange()">
								<p id="nicklabel" style='color: white'>중복확인을 해주세요</p>
							</div>
							<div class="col-md-4">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input placeholder="이메일" type="email" name="email" id="email"
									value="${vo.EMAIL }" onchange="emailchange()">
								<p id="emaillabel" style='color: white'>중복확인을 해주세요</p>
							</div>
							<div class="col-md-4">
						...
						<div class="form-group">
							...
							<div class="col-md-12" style="width: 200px">
								...
								<label>양력</label> &nbsp;&nbsp;&nbsp; <input type="radio"
									name="calendar" value="lunar"> <label>음력</label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select id="user_height" name="user_height" class="w3-select"
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select id="user_loc" name="user_loc" class="w3-select"
									style="width: 100px; height: 30px">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select id="user_body" name="user_body" class="w3-select"
									style="width: 100px; height: 30px">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select id="ideal_height" name="idealvo.ideal_height"
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								...
								<textarea name="user_intro" id="user_intro" cols="50" rows="10"
									class="form-control" placeholder="자기소개를 입력해주세요"></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-md-4">
								...
								<button class="btn btn-primary" type="button" id="send"
									style="text-align: center">수정</button>
	...
	<script>
		$(function() {
			...
			$('#user_height option').val(user_height).attr('selected',
					'selected');
			$('#user_loc option').val(user_loc).attr('selected', 'selected');
			$('#user_body option').val(user_body).attr('selected', 'selected');
			$('#ideal_height option').val(ideal_height).attr('selected',
					'selected');
			$('#ideal_body option').val(ideal_body)
	...
	<script>
									...
									.ajax({
										...
										success : function(data) { //data==1 : 중복되는 값이 있음. data==0: 중복되는 값이 없음.
											...
											if ($('#nickname').val() === '') { //빈칸일 때.
												nickchk = 'false';
												document
														.getElementById("nicklabel").innerHTML = "<p style='color:red'>별명을 입력해주세요</p>";
												return;
											} else if (data === 1
													&& $('#nickname').val() !== nickname) { //중복되는 값이 있고, 원래 별명과 값이 달라졌을 때.
												nickchk = 'false';
												document
												...
												document
													...
													&& $('#nickname').val() !== nickname) { //중복되는 값이 없고, 원래 별명값이랑 다를 때.
												nickchk = 'true';
												document
														.getElementById("nicklabel").innerHTML = "<p style='color:blue'>사용가능한 별명입니다.</p>";
											}
		...
		$('#send').on(
				'click',
				function() {
					if (nickchk === 'true' && idchk === 'true'
							&& rexemail === 'true' && namechk === 'true') { //모든 체크가 완료시 submit;			
						$('#form').submit();
