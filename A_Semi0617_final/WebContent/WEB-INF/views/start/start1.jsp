...
<body>
			...
			<div class="wrapper">
				<div class="slidelist">
					<div class="container text-center">
						...
						<form  method="post" action="joinaction" class="login100-form validate-form" id="joinform">
											...
											<div class="form-group">
												...
												<div class="col-md-2" style="float: none; margin: 0 auto;">
													<select id="ideal_height" name="ideal_height"
														class="form-control">
														<c:forEach begin="130" step="1" end="200" var="i">
																<option value="${i }">${i }시</option>
														</c:forEach>
													</select>
												</div>
							...
							<div class="panel-body">
								...
								<div class="container-login100-form-btn text-center">
									<div class="wrap-login100-form-btn">
										...
										<button class="btn btn-outline-info" id="joinsucess">
											회원가입완료</button>
									</div>
								</div>
								<br>
	...
	<script>
		...
		//step1~7 전송
		//전송할 때, 중복체크 여부 확인
		$('#joinsucess').on('click',function() {
					if (nickchk === 'true' && idchk === 'true'&& rexemail === 'true' && emailchk === 'true'
