								...
								<div class="form-group">
									<input type="text" class="form-control" id="content"
										...
										<button type="button" id="replySubmit"
											class="btn py-2 px-2 btn-primary" style="float: right;">댓글달기</button>
									</span>
								</div>
							</form>
						</div>
													...
													<c:if test="${sessionScope.user_num == item.USER_NUM}">
														<div id="cmBtn_group">
															<button type="button" onclick="updatecmt_chk1()"
																id="cntUpdateBtn">수정</button>
															<button type="button"
																onclick="deletedComment('${item.CM_NUM}')"
																id="cntDeleteBtn">삭제</button>
														</div>
													</c:if>
													<c:if test="${sessionScope.user_num ne item.USER_NUM}">
														<div id="cmBtn_group">
															<button type="button" data-toggle="modal"
																...
																class="modal_open_btn2">신고</button>
														</div>
													</c:if>
												</div>
											...
											<div id="cmt02" style="display: none;">
												...
												<div id="cmBtn_group" style="float: right;">
													<button type="button"
														...
														id="cntUpdateBtn2">수정</button>
													<button type="button" onclick="cancel_updatecmt()"
														id="cntDeleteBtn2">취소</button>
												</div>
											</div>
										</div>
											...
											<form class="bg-light">
												<div class="form-group">
													<input type="text" id="replyContent${item.CM_NUM}"
														onkeyup="replyenterkey()" placeholder="내용을 입력하세요.">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form method="post" id="checked" action="reportBoard">
						<input type="radio" name="report_board" value="의심스럽거나 스팸입니다."
							checked /> 의심스럽거나 스팸입니다. <br />
						<br /> <input type="radio" name="report_board"
							value="계정 해킹이 의심됩니다." /> 계정 해킹이 의심됩니다.<br />
						<br /> <input type="radio" name="report_board"
							value="신고자 본인,또는 타인을 사칭하고 있습니다." /> 신고자 본인,또는 타인을 사칭하고 있습니다.<br />
						<br /> <input type="radio" name="report_board"
							value="가학적이거나 혐오내용을 담은 내용입니다." /> 가학적이거나 혐오내용을 담은 내용입니다.<br />
						<br /> <input type="radio" name="report_board"
							value="나체이미지 또는 성적 행위" /> 나체이미지 또는 성적 행위<br />
						<br /> <input type="radio" name="report_board"
							value="불법 또는 규제 상품 판매" /> 불법 또는 규제 상품 판매<br />
						<br />
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-secondary"
						data-dismiss="modal" id="report_cancel">취소</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form method="post" id="checked" action="reportComment">
						<input type="radio" name="report_comment" value="의심스럽거나 스팸입니다."
							checked /> 의심스럽거나 스팸입니다. <br />
