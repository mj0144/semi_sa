...
<script>
	$(document).ready(function() {
		...
		$.ajax({
			url : "http://192.168.0.172:8000/dpl/result2?result_img="+result_img,
			success : function(data) {
				data = data.replace(/&#x27;/gi, '"').replace(/&#x27;/gi, '"')
				data = JSON.parse(data)
				iljuBasic = $("#iljuResult").text().split(" ")
				result = ''
				console.log(data[0]['당신은'])
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 text-center">
					...
					<div class="single-team">
						<div class="explain">
							...
							<p class="card-text">${ilju.result_animal}은(는)${ilju.ilju}일주
								입니다.</p>
							<p class="card-text" id="iljuResult">${ilju.result_basic}</p>

							<h5>유명인 중 나와 잘맞는 일주동물을 가진 사람</h5>
				...
				<div class="col-md-4 col-md-offset-4 text-center">
					<h3>
						<strong><a href="listSome?code=1">다른 테스트</a></strong>
					</h3>
					<div class="single-team">
						<div class="team-photo">
							<div class="explain">
